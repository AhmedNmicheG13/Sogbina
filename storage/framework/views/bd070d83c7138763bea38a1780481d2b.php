                            ...
                            <div class="driver-info">
                                <div>
                                    <div class="name">
                                        ...
                                        ?>
                                        <?php echo e($firstNameInitial); ?>. <?php echo e($lastName); ?>

                                    </div>
                                    <?php if($trajet->user->national_id_recto || $trajet->user->national_id_verso): ?>
                                        <button class="btn-status active">Compte vérifié</button>
                                    <?php else: ?>
                                        <button class="btn-status inactive">Compte non vérifié</button>
                                    <?php endif; ?>
                                </div>
                                <div class="driver-image-wrapper" style="border-color: <?php echo e($borderColor); ?>;">
                                    <?php if($trajet->user->profile_picture): ?>
                                        <img src="<?php echo e(asset('images/' . $trajet->user->profile_picture)); ?>" alt="Photo du conducteur" class="driver-image" data-toggle="modal" data-target="#driverInfoModal<?php echo e($trajet->user->id); ?>">
                                    <?php else: ?>
                                        <div class="default-profile driver-image" data-toggle="modal" data-target="#driverInfoModal<?php echo e($trajet->user->id); ?>"><i class="fas fa-user"></i></div>
                                    <?php endif; ?>
                                    <div class="badge-inside <?php echo e($trajet->user->national_id_recto && $trajet->user->national_id_verso ? '' : 'inactive'); ?>"><i class="fas fa-check-circle"></i></div>
                                </div>
                            </div>
                            <div class="trip-details">
                                <div class="city-time">
                                    <div>
                                        <strong><?php echo e($trajet->depart); ?></strong>
                                        <div class="time"><?php echo e($trajet->heure_depart); ?></div>
                                    </div>
                                    <div class="line">
                                        <span></span>
                                    </div>
                                    <div>
                                        <strong><?php echo e($trajet->arrivee); ?></strong>
                                        <div class="time"><?php echo e($trajet->heure_arrivee); ?></div>
                                    </div>
                                </div>
                                <div class="duration-container">
                                    <i class="fas fa-clock duration-icon"></i>
                                    <?php echo e(gmdate('H', strtotime($trajet->heure_arrivee) - strtotime($trajet->heure_depart))); ?><span class="duration-h">h</span>
                                    <?php echo e(gmdate('i', strtotime($trajet->heure_arrivee) - strtotime($trajet->heure_depart))); ?> min
                                </div>
                                <span class="date"><?php echo e(\Carbon\Carbon::parse($trajet->date)->translatedFormat('d F Y')); ?></span>
                                <span class="places"><?php echo e($trajet->places); ?> places disponibles</span>
                                <span class="passenger-icons" data-places="<?php echo e($trajet->places); ?>"></span>
                            </div>
                            <div class="price"><?php echo e($trajet->prix); ?> €</div>
                            <button class="btn-reserver">Réserver</button>
                        </div>

                        <!-- Driver Info Modal -->
                        <div class="modal fade" id="driverInfoModal<?php echo e($trajet->user->id); ?>" tabindex="-1" role="dialog" aria-labelledby="driverInfoModalLabel<?php echo e($trajet->user->id); ?>" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="driver-info-modal">
                                            <img src="<?php echo e(asset('images/' . $trajet->user->profile_picture)); ?>" alt="Photo du conducteur" style="border-color: <?php echo e($borderColor); ?>;">
                                            <div class="name"><?php echo e($trajet->user->name); ?></div>
                                            <div class="badge <?php echo e($badgeColor); ?>"><?php echo e($levelText); ?></div>
                                        </div>
                                        <div class="info-icons">
                                            <i class="fas fa-phone"></i> <span class="<?php echo e($trajet->user->phone ? 'verified' : 'not-verified'); ?>"><?php echo e($trajet->user->phone ? 'Numéro de téléphone vérifié' : 'Numéro de téléphone non vérifié'); ?></span>
                                        </div>
                                        <div class="info-icons">
                                            <i class="fas fa-envelope"></i> <span class="<?php echo e($trajet->user->email ? 'verified' : 'not-verified'); ?>"><?php echo e($trajet->user->email ? 'Adresse e-mail vérifiée' : 'Adresse e-mail non vérifiée'); ?></span>
                                        </div>
                                        <div class="info-icons">
                                            <i class="fas fa-car"></i> <span>Marque de voiture: <?php echo e($trajet->user->car_brand); ?></span>
                                        </div>
                                        <div class="info-icons">
                                        ...
                                        <div class="info-icons">
                                            <i class="fas fa-flag"></i> <span>Pays: <?php echo e($trajet->user->country); ?></span>
                                        </div>
                                        <div class="info-icons">
                                            <i class="fas fa-city"></i> <span>Ville: <?php echo e($trajet->user->city); ?></span>
                                        </div>
                                        <div class="info-icons">
                                            <i class="fas fa-map-pin"></i> <span>Code postal: <?php echo e($trajet->user->postal_code); ?></span>
                                        </div>
                                    </div>
...
<?php /**PATH /htdocs/resources/views/front/results.blade.php ENDPATH**/ ?>