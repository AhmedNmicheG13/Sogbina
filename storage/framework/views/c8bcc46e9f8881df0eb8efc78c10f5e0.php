...
<div class="navbar">
    <div class="navbar-logo">
        <img src="<?php echo e(asset('images/' . ($settings->logo ?? ''))); ?>" alt="">
    </div>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="Adresse e-mail">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <div class="col-md-12 input-group">
...
<?php /**PATH /htdocs/sogbina/resources/views/admin/mobile_nav.blade.php ENDPATH**/ ?>