...
<head>
    ...
    <style>
        ...
        .navbar-nav-desktop a {
            ...
            color: {{ $settings->text_color_menu ?? '#FFF' }};
            text-transform: capitalize;
        ...
        .dropdown-btn-desktop {
            display: flex;
            align-items: center;
            background-color: {{ $settings->header_color_large ?? 'BLACK' }};  
            color: #fff !important;     /* ÙÂÙÂÙÂ Ø§ÙÂÙÂØµ Ø§ÙÂØ£Ø¨ÙÂØ¶ */
            padding: 10px 15px;         /* Ø§ÙÂØ­Ø´ÙÂ Ø¯Ø§Ø®ÙÂ Ø§ÙÂØ²Ø± */
            border-radius: 5px;         /* Ø§ÙÂØ²ÙÂØ§ÙÂØ§ Ø§ÙÂÙÂØ³ØªØ¯ÙÂØ±Ø© */
            cursor: pointer;            /* ÙÂØ¤Ø´Ø± Ø§ÙÂÙÂØ£Ø±Ø© Ø¹ÙÂÙÂ Ø§ÙÂØªØ­ÙÂÙÂÙÂ */
        }
...
<div class="navbar-desktop">
    <div class="navbar-logo">
        <img src="{{ asset('images/' . ($settings->logo ?? 'https://webfx.fr/images/1722354722_logo.png')) }}" alt="">
    </div>
    <div class="navbar-nav-desktop">
        <a href="{{ url('/') }}" class="nav-link-custom">Accueil</a>
        <a href="{{ url('/blog') }}" class="nav-link-custom">Blog</a>
...
<div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- ÙÂÂÂÂÂÂÙÂÂÂÂÂÂÙÂÂÂÂÂÂÙÂÂÂÂÂÂÙÂÂÂÂÂÂ Ø¥Ø¶Ø§ÙÂÂÂÂÂÂØ© ÙÂÂÂÂÂÂÙÂÂÂÂÂÂÙÂÂÂÂÂÂØ°Ø¬ Ø§ÙÂÂÂÂÂÂØªØ³Ø¬ÙÂÂÂÂÂÂÙÂÂÂÂÂÂ ÙÂÂÂÂÂÂÙÂÂÂÂÂÂØ§ -->
