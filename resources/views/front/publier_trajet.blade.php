...
<div class="form-container mx-auto mt-5" style="width: 100%; border: none; box-shadow: none;">
    <form id="trajetForm" action="{{ route('trajet.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        @if (!Auth::user()->profile_picture || !Auth::user()->car_brand || !Auth::user()->car_serial || !Auth::user()->national_id_recto || !Auth::user()->national_id_verso)
